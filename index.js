...
const searchYoutube = async ()=>
{
   ...
   let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?channelType=any&maxResults=20&q=${input}&key=AIzaSyB6D4ulj8vEPbNnXUhPESyJrd1JfQQzQSQ&part=snippet`);   // use here input api for search
...
const mostPopular = async () =>
{
     ...
     try{
           ...
           let res = await fetch(`https://youtube.googleapis.com/youtube/v3/videos?chart=mostPopular&maxResults=20&regionCode=IN&key=AIzaSyB6D4ulj8vEPbNnXUhPESyJrd1JfQQzQSQ&part=snippet`) // use here most popular api
...
const searchResult = async ()=>
{
   ...
   let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?channelType=any&maxResults=20&q=${search}&key=AIzaSyB6D4ulj8vEPbNnXUhPESyJrd1JfQQzQSQ&part=snippet`); // use here again  input api
