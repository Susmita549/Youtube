...
const searchYoutube = async ()=>
{
   ...
   let res = await fetch(`https://youtube.googleapis.com/youtube/v3/videos?chart=mostPopular&maxResults=20&regionCode=IN&key=AIzaSyB6D4ulj8vEPbNnXUhPESyJrd1JfQQzQSQ&part=snippet`); // use here input api for showing data in right side
